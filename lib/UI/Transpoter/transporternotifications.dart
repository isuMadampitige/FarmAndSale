...
class NotificateTransporter extends StatefulWidget {
  List<Notifications> notifications;
  NotificateTransporter({this.notifications});
  @override
...
class _Notificatiionstate extends State<NotificateTransporter> {
  bool isloading = true;
