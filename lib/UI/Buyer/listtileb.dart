...
import 'package:login2/UI/Buyer/viewitembuyer.dart';
...
class Productlisttile extends StatelessWidget {
  ...
  Productlisttile({this.context, this.tile,this.id});
      ...
      child: InkWell(
                        ...
                        children: <Widget>[
                          ...
                          Row(
                            ...
                            children: <Widget>[
                              ...
                              Text('Total:-'+tile.quantity.toString()+'/'+tile.quantity_unit.toString(),
                                  style: TextStyle(
                                    fontSize: 13,
                                  )),
                            ],
        ...
        onTap: () {
          Navigator.push(
              context,
              MaterialPageRoute(
                builder: (context) => Viewlisttilebuyer(
                  tile: tile,id: id ,
                ),
              ));
        },
