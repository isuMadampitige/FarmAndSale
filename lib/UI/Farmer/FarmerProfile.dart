...
//user.Usr logeduser;
  ...
  int fid;
  Usr userfarmer;
  FarmerProfile({this.farmer_id, this.fid, this.userfarmer});
...
//final String url='https://www.cropscience.bayer.com/-/media/bcs-inter/ws_globalportal/crop-science/smallholder-farming/smallholder-farming-in-india.jpg';
  ...
  Future _profileinfo() async {
    String url = 'http://34.87.38.40/farmer/' + widget.farmer_id.toString();
                                  ...
                                  child: ClipOval(
                                    child: Container(
                                      ...
                                      child: (_image != null)
                                          ...
                                          : Text(userfarmer.fullname[0].toUpperCase(),style: TextStyle(color: Colors.white,fontSize: 35),),
                                    ),
                                  ),
                                )),
                          ),
