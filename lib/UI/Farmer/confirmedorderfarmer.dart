...
import 'package:login2/UI/Farmer/confirmedorderview.dart';
import 'package:login2/detaileduser.dart';
import 'package:http/http.dart' as http;

class Myconfirmitem extends StatefulWidget {
  List<product> myitems;
  int id;

  Myconfirmitem({this.myitems, this.id});

  @override
  _MyconfirmitemState createState() => _MyconfirmitemState();
}

class _MyconfirmitemState extends State<Myconfirmitem> {
  //_MyitemState();
    ...
    try {
      await http.get(url).then((response) {
        ...
        if (response.statusCode == 200) {
          ...
          if (content == '[]') {
            NoItempopup(this.context,'You Havent added any item Yet');
            setState(() {
              boolcheck = false;
            });
          } else {
            setState(() {
              myitems = prdct.map((json) => product.fromjson2(json)).toList();
              boolcheck = true;
                ...
                child: boolcheck
                    ? ListView.builder(
                        ...
                        itemBuilder: (context, index) {
                          ...
                          //         leading: Hero(
                          //           tag: myitems[index].purchase_item_id,
                          //           child: Container(
                          //               height: 50,
                          //               width: 50,
                          //               decoration: BoxDecoration(
                          ...
                          //                       fontSize: 10,
                          //                       fontWeight: FontWeight.bold)),
                          //               Text(myitems[index].quantity.toString(),
                          //                   //'800 kg',
                          //                   style: TextStyle(
                          //                       fontSize: 10,
                          //                       fontWeight: FontWeight.bold))
                          ...
                          //           children: <Widget>[
                          //             Text(myitems[index].harvest_date.toString(),
                          //                 style: TextStyle(
                          //                     fontSize: 12,
                          //                     fontWeight: FontWeight.bold)),
                          //             // Text(
